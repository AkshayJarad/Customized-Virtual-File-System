...
void DisplayHelp()
{
    ...
    printf("fsat : To Display information of file uing file Descriptor\n");
...
int fstat_file(int fd)
{
    ...
    printf("File Size : %d",temp->FileSize);
    ...
    while(1)
    {
        ...
        else if(count == 4)
        {
            if(strcmp(command[0],"Iseek") == 0)
            {
                ...
                if(ret == -1)
                {
                     printf("ERROR : Unnable to perform Iseek\n");
                }
            }
            else
            {
